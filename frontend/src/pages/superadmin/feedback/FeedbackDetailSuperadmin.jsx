...
const FeedbackDetailSuperadmin = () => {
  const { id } = useParams();
      ...
      api.get(`/feedbacks/${id}`)
        ...
        .catch((err) => {
          ...
          MySwal.fire({
            ...
            icon: 'error',
          }).then(() => navigate('/superadmin/feedbacks'));
        });
    }
      ...
      <div style={{ paddingLeft: '80px', paddingTop: '90px', minHeight: '100vh' }}>
        <Container>
          ...
          <Card className="p-4">
            ...
            <div className="mt-3">
              <Button variant="secondary" onClick={() => navigate('/superadmin/feedbacks')}>
...
export default FeedbackDetailSuperadmin;

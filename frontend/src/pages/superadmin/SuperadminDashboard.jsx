...
const SuperadminDashboard = () => {
  ...
  useEffect(() => {
    if (!isSuperadmin()) {
      Swal.fire('Akses Ditolak', 'Silakan login sebagai superadmin.', 'warning')
  ...
  return (
    <>
      ...
      <div style={{ paddingLeft: '120px', paddingRight: '40px', paddingTop: '90px', paddingBottom: '20px', minHeight: '100vh' }}>
        <Container fluid>
          <h4 className="mb-4">Statistik Dashboard Superadmin</h4>
            ...
            <Row className="mb-4">
              <Col md={3}>
                <Card bg="info" text="white">
                  <Card.Body>
                    <Card.Title><UserCheck className="me-2" size={20} /> Admin Aktif</Card.Title>
                    <Card.Text className="fs-3">{stats.admins.aktif}</Card.Text>
                  </Card.Body>
                </Card>
              </Col>
              <Col md={3}>
                <Card bg="dark" text="white">
                  <Card.Body>
                    <Card.Title><UserX className="me-2" size={20} /> Admin Nonaktif</Card.Title>
                    <Card.Text className="fs-3">{stats.admins.nonaktif}</Card.Text>
                  </Card.Body>
                </Card>
              </Col>
            </Row>

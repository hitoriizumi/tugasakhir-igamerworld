...
const OrderProductDetail = () => {
  ...
  const fetchOrderDetail = useCallback(async () => {
    try {
      const res = await api.get(`/orders/admin/product/${id}`);
  ...
  const handleSubmitStatusChange = async () => {
    ...
    try {
      await api.patch(`/orders/admin/product/${order.id}/update-status`, payload);
      setShowModal(false);
      ...
      <div style={{ paddingLeft: 80, paddingTop: 90, minHeight: '100vh' }}>
        <Container>
          {loading ? (
            ...
            <>
              <h4 className="fw-bold mb-4">Detail Pesanan Produk Biasa</h4>
              ...
              <div className="d-flex flex-wrap gap-3 justify-content-end">
                ...
                <Button
                  variant="primary"
                  onClick={() => navigate(`/admin/orders/product/${order.id}/payment`)}
                ...
                <Button
                  variant="info"
                  onClick={() => navigate(`/admin/orders/product/${order.id}/delivery`)}
